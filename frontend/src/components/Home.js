  ...
  <div className='scroll-container'>
    ...
    <div className='scroll-review' ref={scrollContainerRef}>
      {[
        {
          name: "Sarah Johnson",
          message: "Amazing food and excellent service! The vegan burger was one of the best I've ever had. Highly recommend!",
          date: "2024-03-15"
        },
        {
          name: "Michael Chen",
          message: "Fantastic dining experience. The ambiance was perfect and the staff went above and beyond. Loved the quinoa salad!",
          date: "2024-03-18"
        },
        {
          name: "Emma Wilson",
          message: "Fresh ingredients and creative recipes. The avocado toast with poached eggs was divine. Will definitely return!",
          date: "2024-03-20"
        },
        {
          name: "David Patel",
          message: "Outstanding vegan options! The jackfruit tacos were bursting with flavor. Great cocktail selection too.",
          date: "2024-03-22"
        },
        {
          name: "Olivia Smith",
          message: "Perfect spot for health-conscious foodies. The gluten-free desserts were a delicious surprise. 5 stars!",
          date: "2024-03-25"
        }
      ].map((feed, index) => (
